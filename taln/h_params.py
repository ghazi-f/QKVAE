...
class DefaultSSSentenceClassificationHParams(DefaultHParams):
    def __init__(self, vocab_size, tag_size, max_len, batch_size, n_epochs, device=None, cycle_loss_w=0.0,
                 vocab_ignore_index=None, **kwargs):
        default_kwargs = {'vocab_size': vocab_size,
                          'tag_size': tag_size,
                          'max_len': max_len,
                          'batch_size': batch_size,
        ...
        self.vocab_ignore_index = vocab_ignore_index
        self.cycle_loss_w = cycle_loss_w
# ======================================================================================================================
