...
def get_non_auto_regressive_lstm_encoder_disentanglement_graph(h_params, word_embeddings, pos_embeddings):
    xin_size, zin_size = h_params.embedding_dim, h_params.z_size
    xout_size, zout_size = h_params.vocab_size, h_params.z_size
    z_repnet = nn.LSTM(h_params.z_size, h_params.z_size, h_params.text_rep_l,
                       batch_first=True,
...
def get_structured_disentanglement_graph(h_params, word_embeddings, pos_embeddings):
    xin_size, zin_size = h_params.embedding_dim, h_params.z_size
    xout_size, zout_size = h_params.vocab_size, h_params.z_size
    z_repnet = nn.LSTM(h_params.z_size, h_params.z_size, h_params.text_rep_l,
                       batch_first=True,
    ...
    z_to_zlstm = LastStateMLPLink(xin_size, h_params.encoder_h, zout_size, h_params.encoder_l, Gaussian.parameter_activations,
                     highway=h_params.highway, dropout=h_params.dropout)
    z_to_z1 = CoattentiveTransformerLink(xin_size, h_params.encoder_h, zout_size, h_params.encoder_l,
                                        Gaussian.parameter_activations, nheads=4,
                                        highway=h_params.highway, dropout=h_params.dropout, n_targets=lv_number)
    z1_to_z2 = CoattentiveTransformerLink(xin_size, h_params.encoder_h, zout_size, h_params.encoder_l,
                                        Gaussian.parameter_activations, nheads=4,
                                        highway=h_params.highway, dropout=h_params.dropout, n_targets=lv_number)

    # Inference
    x_inf, z_inf, z_inf1, z_inf2, zlstm_inf = XInfer(h_params, word_embeddings, has_rep=True),\
