...
from pos_tagging.models import PureGeneration as Model
...
parser.add_argument("--pos_embedding_dim", default=32, type=int)
...
parser.add_argument("--grad_clip", default=0.25, type=float)
...
if True:
    flags.losses = 'Reconstruction'
    flags.batch_size = 60
    flags.grad_accu = 1
    flags.max_len = 40
    flags.test_name = "SSVAE/WikiGen3"
...
def main():
    ...
    h_params = HParams(len(data.vocab.itos), len(data.tags.itos), MAX_LEN, BATCH_SIZE, N_EPOCHS,
                       ...
                       is_weighted=[], graph_generator=get_lm_graph, z_size=flags.z_size,
                       ...
                       loss_params=LOSS_PARAMS, piwo=PIWO, optimizer=optim.SGD, markovian=flags.markovian,
