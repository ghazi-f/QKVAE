...
def main():
    ...
    with open(flags.csv_out, 'a') as f:
        f.write('\t'.join([flags.test_name, str(flags.encoder_h), str(flags.z_size), str(flags.graph), str(flags.data),
                           ...
                           str(dev_kl), str(dev_kl_std), str(pp_ub), str(sum([str(val_dec_lab_wise_disent[k]) for k in relations])),
                           # str(sum([str(val_dec_lab_wise_disent_recon[k]) for k in relations])),
                           str(sum([str(val_enc_lab_wise_disent[k]) for k in relations])),
                           ...
                           *[str(val_enc_lab_wise_disent[k]) for k in relations], str(dev_rec),
                           ...
                           str(test_kl), str(test_kl_std), str(test_pp_ub), str(sum([str(test_dec_lab_wise_disent[k]) for k in relations])),
                           # str(sum([str(test_dec_lab_wise_disent_recon[k]) for k in relations])),
