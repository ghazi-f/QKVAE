#!/usr/bin/env bash
python sent_train.py --losses "SSIWAE" --test_name "IMDB/SSIWAE/0.001" --supervision_proportion 0.001 --grad_accu 8 --batch_size 8 --testing_iw_samples 10 --device "cuda:2"
python sent_train.py --losses "SSIWAE" --test_name "IMDB/SSIWAE/0.003" --supervision_proportion 0.003 --grad_accu 8 --batch_size 8 --testing_iw_samples 10 --device "cuda:2"
python sent_train.py --losses "SSIWAE" --test_name "IMDB/SSIWAE/0.01" --supervision_proportion 0.01 --grad_accu 8 --batch_size 8 --testing_iw_samples 10 --device "cuda:2"
