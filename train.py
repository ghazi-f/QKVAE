...
h_params = HParams(len(data.vocab.itos), len(data.tags.itos), MAX_LEN, BATCH_SIZE, N_EPOCHS,
                   ...
                   test_name='PosTagging/test', grad_accumulation_steps=1, optimizer_kwargs={'lr': 1e-4},
                   is_weighted=[], graph_generator=get_graph_postag, z_size=100, embedding_dim=500, anneal_kl=[1000, 4500],
